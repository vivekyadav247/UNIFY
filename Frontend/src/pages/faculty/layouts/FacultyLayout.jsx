...
export default function StudentLayout({
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* SIDEBAR - FIXED */}
      <aside
        className={`fixed left-0 top-0 h-screen w-64 border-r p-6 shadow-sm flex flex-col z-40 ${
      ...
      >
        ...
        <div className="mt-auto pt-6 border-t border-gray-300 dark:border-gray-700">
          <button
            ...
            className={`flex items-center gap-3 p-3 rounded-lg transition-all w-full font-medium text-[15px] ${
              darkMode
                ? "bg-blue-900 text-blue-200 hover:bg-red-900 hover:text-red-200"
      ...
      >
        ...
        {/* PROFILE CARD (now inside scrollable main) - removed fixed positioning so it scrolls with content */}
